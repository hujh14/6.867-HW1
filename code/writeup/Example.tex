...
\begin{figure}[h]
  \includegraphics[width=\linewidth]{../Figures/P3/M=7,L=small.png}
  \caption{Best performing model on test set.}
  \label{fig:gradient_converging}
\end{figure}
\begin{figure}[h]
  \includegraphics[width=\linewidth]{../Figures/P3/medium_fit_better.png}
  \caption{Intermediate $\lambda$ and $M$ values}
  \label{fig:gradient_converging}
\end{figure}
\begin{figure}[h]
  \includegraphics[width=\linewidth]{../Figures/P3/Flat.png}
  \caption{Extremely large $\lambda$ results in low coefficient polynomial.}
  \label{fig:gradient_converging}
\end{figure}
